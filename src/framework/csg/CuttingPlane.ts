...
export default class CuttingPlane extends Plane {
    constructor(normal?: any, constant?: any) {
        super(normal, constant);
    }

    fromPoints(a:any, b:any, c:any) {
        const normal = b
            .subVectors(b, a)
    ...
    setFromCoplanarPoints(a:any, b:any, c:any) {
        var normal = _vector1
            .subVectors(c, b)
    ...
    setFromNormalAndCoplanarPoint(normal:any, point:any) {
    ...
    splitPolygon(polygon:any, coplanarFront:any, coplanarBack:any, front:any, back:any) {
        const COPLANAR = 0;
        const FRONT = 1;
        const BACK = 2;
        const SPANNING = 3;
